...
asset:
	mkdir -p assets
	cd assets;curl https://raw.githubusercontent.com/TachibanaTech/2dust-geoip-getsite/master/geosite.dat > geosite.dat
	cd assets;curl https://raw.githubusercontent.com/TachibanaTech/2dust-geoip-getsite/master/geoip.dat > geoip.dat
